...
$lang = array(
		...
		"requiredFields" => "Please note, that all fields with a star (*) are required.",
		"buttonSave" => "Save",
		"buttonOk" => "OK",
		"buttonCancel" => "Cancel",
		...
		"settings" => "settings",
		"addNewQuestion" => "Use questions from questionpool",
		"importQuestionsFromCSV" => "Import questions from CSV",
		...
		"noPassing" => "No limit",
		"showQuiz" => "This Quiz is available on []. You are able to participate from [1] to [2].<br /><br />Have Fun, [3] ([4])",
		...
		"errorWhileUploading" => "Error while uploading CSV File",
		"noCSVFile" => "Question file is not in CSV format",
		"uploadeCSVHandleError" => "Question file handling error",
		...
		"successfullySavedQuiz" => "Quiz successfully saved",
