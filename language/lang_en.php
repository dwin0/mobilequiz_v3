...
$lang = array(
		...
		"createNextQuestion" => "Create next Question",
		"createNextExecution" => "Create next Execution",
		"help" => "Help",
		"createQuiz" => "Create new quiz",
		"editQuiz" => "Edit quiz [1]",
		"editQuizAction" => "Edit quiz",
		"editExecutionAction" => "Edit execution",
		"quizCreateName" => "Name of quiz",
		"description" => "Remark",
		"generalInformations" => "General Informations",
		"showQuizInfo" => "Show quiz infos",
		"participationOptions" => "Participationoptions",
		"quizStartDate" => "Start date",
		"quizEndDate" => "End date",
		"quizTimeLimitation" => "Time limit of quiz",
		...
		"downloadExcelTemplate" => "Download question-template",
		...
		"ExcelQuestionImageError" => "Question-Image couldn't be linked to the question. Please use 'Import questions with images from Excel' und choose the folder containing the Excel-Template and all images.",
		"ImageNotSavedError" => "An image couldn't be saved.",
		"questionWithoutAnswerError" => "Question without any correct answer found. There has to be at least one correct answer per question.",
		"existingQuestionMessage" => "There's at least one Question which already existed and wasn't newly created.",
		...
		"singlechoiceMult" => "Singlechoice multiplier",
		"noAnswer" => "No answer",
		...
		"percentParticipations" => "Percentage participation",
		...
		"errorWhileUploading" => "Error while uploading the Excel file",
		"noExcelFileError" => "Template file is not in Excel format (.xlsx)",
		"uploadeExcelHandleError" => "Problem with opening Excel file",
		"noQuestionsInExcelError" => "No questions found in Excel-Template",
		...
		"deleteConfirmation" => "Should this really be deleted?",
		"quizSuccessfullyDeleted" => "Quiz successfully deleted",
		"executionSuccessfullyDeleted" => "Execution sucessfully deleted",
		"deletingFailed" => "Error while deleting",
		"dataTableZeroRecords" => "There are no [1] of this kind available",
		...
		"delQuiz" => "Delete quiz",
		"delExec" => "Delete execution",
		"showQuizReport" => "Show report",
		"participateQuiz" => "Participate",
		"showTaskpaper" => "Show taskpaper",
		"showTaskPaperWithSolution" => "Show solutions",
		...
		"singechoiceAnswerError" => "A single-choice-question has to have exactly one correct answer.",
		"multiplechoiceAnswerError" => "A multiple-choice-question has to have at least one correct answer.",
		"noAnswerTextError" => "There's at least one empty answer.",
		"parameterError" => "Not all parameters received.",
		"inputToLong" => "Input is to long (maximum 30 characters).",
		"DB-Insert-Error-answer" => "Database-Error: Answer couldn't be created.",
		"DB-Insert-Error-question" => "Database-Error: Question couldn't be created.",
		"DB-Insert-Error-qunaire_qu" => "Database-Error: Question couldn't be linked to quiz.",
		"DB-Insert-Error-answer_question" => "Database-Error: Answer couldn't be linked to question.",
		"DB-Insert-Error-keyword" => "Database-Error: Keyword couldn't be created.",
		"DB-Update-Error" => "Couldn't update database",
		"DB-Update-Error-Singlechoice" => "Database-Error: Couldn't update other answers to false.",
		"DB-Delete-Error-answer_question" => "Database-Error: Answer couldn't be unlinked from question.",
		"DB-Delete-Error-answer" => "Database-Error: Answer couldn't be deleted.",
		"question-authorization-error" => "You are not allowed to edit this question.",
		"quiz-authorization-error" => "You are not allowed to edit this quiz.",
		"execution-authorization-error" => "You are not allowed to edit this execution.",
		"UnknownQuestionType" => "Couldn't find question-type",
		"QuestionAlreadyInQuiz" => "Some Questions are already linked to the quiz.",
		"notImageError" => "File is not an image",
		"imageResizeError" => "Image resize failed",
		"fileExistsError" => "File already exists",
		"fileNotSupportetError" => "File-Format is not supportet",
		"datatransferError" => "Datatransfer failed"
